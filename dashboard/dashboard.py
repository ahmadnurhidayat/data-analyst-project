...
all_df = pd.read_csv("https://raw.githubusercontent.com/ahmadnurhidayat/data-analyst-project/main/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/ahmadnurhidayat/data-analyst-project/main/dashboard/geolocation.csv')
...
st.caption('Copyright (C) Ahmad Nurhidayat 2024')